...
$list.GETENUMERATOR()| Sort-Object name | % {
    ...
    Try{
        ...
        $Sources= Get-ChildItem $path |sort LastWriteTime -Descending| Select-Object -Skip 1 | Select-Object FullName #|Select-Object -Last 500
        ...
        Foreach ($Source in $Sources){7z a -mx=9 $Destination $Source.fullname  |Out-Null }
